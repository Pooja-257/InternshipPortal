        ...
        <div className="options-grid">
          ...
          <div className="card">
            ...
            <div className="document-section">
              <a href="https://1drv.ms/w/c/2879c4145659eca3/EbIBsyZj98BKjqpuioxI_0UBCzyOG581LKbvD4awaGkupA?e=Boenmq" download>Letter of Recommendation Template</a>
            </div>
            <div className="document-section">
          ...
          <div className="card">
            ...
            <button onClick={() => navigate('/feedback')}>Upload Feedback Form</button>
          </div>
